		...
		case BASIC_GUN:
			{
				...
				Animation basicBulletAnimation = Animation(Resources::getTexture(Resources::TextureID::BULLET), 10, sf::Vector2u(12,16));
		...
		case BIG_GUN:
			{
				...
				Animation specialBulletAnimation = Animation(Resources::getTexture(Resources::TextureID::SPECIALBULLET), 15, sf::Vector2u(32,32));
